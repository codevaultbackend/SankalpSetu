  ...
  return (
    <div className="w-full max-w-6xl mx-auto bg-white rounded-xl shadow-sm p-4 sm:p-6">
      ...
      <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-4">
        <div className="flex items-start gap-3 max-[600px]:flex-col max-[600px]:flex-col">
      ...
      <div className="mt-8 flex items-center justify-between">
        ...
        <button
          onClick={next}
          className="rounded-lg bg-black px-6 py-2 text-sm font-medium text-white hover:bg-gray-900"
        >
          Next →
        </button>
      </div>
